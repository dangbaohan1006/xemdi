...
export default async function PhimPage({ searchParams }: HomePageProps) {
    ...
    try {
        console.log(`[PhimPage] Fetching page ${currentPage}...`);
        const data = await getLatestMovies(currentPage);
        movies = data.items || [];
        pagination = data.pagination;
        console.log(`[PhimPage] Loaded ${movies.length} movies, pagination:`, pagination);
    } catch (e) {
